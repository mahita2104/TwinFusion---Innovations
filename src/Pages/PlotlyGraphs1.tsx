    ...
    async function fetchData() {
      try {
        ...
        if (buttonLabel === "Graph1") {
          dataFilePath = "./graph_plant1_propphet24hr.json"; // Update with the actual file path for Graph1
        } else if (buttonLabel === "Graph2") {
          dataFilePath = "./graph_plant1_propphetvsactual.json"; // Update with the actual file path for Graph2
        } else if (buttonLabel === "Graph3") {
          dataFilePath = "./graph_plant1_timestampac.json"; // Update with the actual file path for Graph3
        }
